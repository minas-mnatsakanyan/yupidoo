<?php /* Smarty version Smarty-3.1.19, created on 2016-07-06 07:25:41
         compiled from "C:\xampp-portable\htdocs\yupido\modules\liveperson\views\templates\admin\configure.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13768577ceab5c0d5d1-14576123%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56c73af3461fa0623e47ab62ea3a70aedc9f19d5' => 
    array (
      0 => 'C:\\xampp-portable\\htdocs\\yupido\\modules\\liveperson\\views\\templates\\admin\\configure.tpl',
      1 => 1467804336,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13768577ceab5c0d5d1-14576123',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_577ceab5e5f252_56761499',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_577ceab5e5f252_56761499')) {function content_577ceab5e5f252_56761499($_smarty_tpl) {?>
...
width:100%;
height:540px;
background:url(<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module_dir']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
/img/banner1024.jpg) no-repeat;
}
...
<div class="top_section">
	<img class="top_logo" src="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module_dir']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
/img/logo.png" />
	<div class="top_left">
...
/img/main_img.png" />
	...
	<div class="top_right">
		...
		<form id="configuration_form" style = "margin:30px 15px 15px 0;" class="defaultForm form-horizontal liveperson" action="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['link']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" method="post" enctype="multipart/form-data" novalidate="">
		<p class="top_subtitle">Connect Your LiveEngage Account:</p>
			<input type="hidden" name="submitliveperson" value="1">
			<input name="LP_SITEID" id="LP_SITEID" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['lp_site_id']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" class="id_input" type="text" placeholder="LiveEngage SiteID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'LiveEngage Site ID'" />
		<?php if (($_smarty_tpl->tpl_vars['lp_site_id']->value>"0")) {?>
...
<div class="middle_boxes">
	<div class="box_inner" style="border:0">
		<img class="box_image" src="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module_dir']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
/img/icon_cart.jpg" />
